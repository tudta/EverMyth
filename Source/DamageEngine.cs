    ...
    public static class DamageEngine
    {
        ...
        private static void DetectDamage()
        {
            ...
            if (BlzGetEventIsAttack())
            {
                ...
                DamageUnit(damagingUnitInstance, damagedUnitInstance, DamageType.PHYSICAL, damagingUnitInstance.UnitData.TotalPhysicalAttackDamage);
                DamageUnit(damagingUnitInstance, damagedUnitInstance, DamageType.MAGICAL, damagingUnitInstance.UnitData.TotalMagicalAttackDamage);
            }
        }
        ...
        public static void DamageUnit(UnitInstance damageSource, UnitInstance damageTarget, DamageType damageType, float damageAmount)
        {
            int roundedDamage = 0;
